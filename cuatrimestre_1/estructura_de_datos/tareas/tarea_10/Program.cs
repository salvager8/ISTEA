...
namespace tarea_10
{
	class Program
	{
		...
		private static void ImprimirEnunciado() {
			...
			Console.WriteLine("\tGenerar una aplicación consola con un sistema de ventas de productos, el mismo constara de 3 listas de igual cantidad de elementos:");
			Console.WriteLine("\tla misma contara con la siguiente estructura:\n");
			Console.WriteLine("\tProductos--> \"TV\",\"Heladera\",\"Lavarropa\",\"Cocina\"");
			Console.WriteLine("\tPrecios(Double) ---> precios a definir");
			Console.WriteLine("\tCant.(int)--->cantidad a definir");
			Console.ResetColor();
			EnterParaContinuar();
		}
