...
namespace tarea_11
{
	class Program
	{
		...
		private static void ImprimirEnunciado() {
			...
			Console.WriteLine("\tRealizar una aplicación consola que a partir de dos listas genere una repositorio de mails y contraseñas,");
			Console.WriteLine("\tla misma deberá verificar que los mails y usuarios a ingresar pasen por los requisitos de seguridad mínima y");
			Console.WriteLine("\tademás que no estén ya ingresados en la lista. Todo deberá ser desarrollado con funciones y expresiones regulares.\n");
			Console.ResetColor();
			EnterParaContinuar();
		}
		...
		private static void MostrarOpciones() {
			string[] opciones = new string[] { "Ingreso", "Mostrar", "Salir" };
			Console.Clear();
