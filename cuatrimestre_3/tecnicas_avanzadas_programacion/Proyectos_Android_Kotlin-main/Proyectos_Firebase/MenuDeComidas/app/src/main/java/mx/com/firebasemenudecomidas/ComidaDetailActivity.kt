        ...
        if (savedInstanceState == null) {
            ...
            val fragment = ComidaDetailFragment().apply {
                arguments = Bundle().apply {
                    putString(
                        ComidaDetailFragment.ARG_ITEM_ID,
                        intent.getStringExtra(ComidaDetailFragment.ARG_ITEM_ID)
                    )
                }
            }
    ...
    override fun onOptionsItemSelected(item: MenuItem) =
        when (item.itemId) {
            android.R.id.home -> {
                ...
                navigateUpTo(Intent(this, ComidaListActivity::class.java))
