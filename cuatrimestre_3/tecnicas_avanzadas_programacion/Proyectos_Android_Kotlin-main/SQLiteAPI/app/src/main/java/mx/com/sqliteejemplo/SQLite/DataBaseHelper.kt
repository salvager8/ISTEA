...
class DataBaseHelper(context: Context): SQLiteOpenHelper(context,
    AlumnosContract.Companion.Entrada.NOMBRE_TABLA, null,
    AlumnosContract.VERSION
) {

    companion object {
        val CREATE_ALUMNOS_TABLA = "CREATE TABLE ${AlumnosContract.Companion.Entrada.NOMBRE_TABLA} (${AlumnosContract.Companion.Entrada.COLUMNA_ID} TEXT PRIMARY KEY, " +
